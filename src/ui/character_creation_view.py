...
class CharacterCreationView:
    ...
    def _handle_create(self):
        ...
        if name_value and archetype_value and age_value:
            ...
            self._character.set_archetype(AVAILABLE_ARCHETYPES[archetype_value])
    ...
    def _initialize(self):
        ...
        character_name_label.grid(row=1, column=0, padx=5, pady=5, sticky=(constants.E, constants.W))
        self._character_name_entry.grid(row=1, column=1, padx=5, pady=5, sticky=(constants.E, constants.W))

        character_archetype_label.grid(row=2, column=0, padx=5, pady=5, sticky=(constants.E, constants.W))
        self._character_archetype_checkbox.grid(row=2, column=1, padx=5, pady=5, sticky=(constants.E, constants.W))

        character_age_label.grid(row=3, column=0, padx=5, pady=5, sticky=(constants.E, constants.W))
        self._character_age_spinbox.grid(row=3, column=1, padx=5, pady=5, sticky=(constants.E, constants.W))
