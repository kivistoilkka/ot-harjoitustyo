...
class TestArchetypeRepository(unittest.TestCase):
    ...
    def test_certain_archetype_information_is_correct(self):
        ...
        self.assertEqual(str(
            hunter.talents["Bloodhound"]), "Bloodhound: Gain +2 to... (available for Hunter)")
        self.assertEqual(str(
            hunter.talents["Herbalist"]), "Herbalist: By utilizing... (available for Hunter)")
        self.assertEqual(
            str(hunter.talents["Marksman"]), "Marksman: Gain +2 to... (available for Hunter)")
        ...
        self.assertEqual(hunter.equipment[2],
                         ("hunting trap", "hunting equipment"))
